...
const ReviewContainer = styled.div`
  ...
  padding: 10px;
  margin-top: 20px;
  visibility: ${props => props.hasReviews ? 'visible' : 'hidden'};
`;
    ...
    if (!flag) alert("Already added to cart");
      ...
      axios
        .post(`${url}/homepage/addtocart`, {
          ...
          productid: productid,
          fabric: param2.fabric,
          color: param2. colours,
          price: param2.price,
          image:param1,
          productid:productid,
          description:param2.description,
          fit:param2.fit,
          washinginstructions:param2.washing_instructions,
          specialattribute: param2.specialattribute,
          approxprice:param2.approx_price,
        })
        .then((res) => {
    ...
    <Body>
      ...
      <ProductContainer>
        <ProductDetails>
          ...
          <ReviewContainer hasReviews={allReviews.length > 0}>

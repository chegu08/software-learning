...
import InspectDesignerOrder from './desigenerpage/inspectDesignerOrder';
import UpdatePayment from './userpages/updatePayment';
import Genimg from './userpages/imagegeneration';
import CreateUserProduct from './userpages/createUserProduct';
export const url="https://499f-2409-40f4-2a-1976-45c5-c480-2a3f-fe32.ngrok-free.app";
const router=createBrowserRouter([
  ...
  {
    path:"/updatePayment/:orderID/:paymentID",
    element:<UpdatePayment/>,
  }
  ,
  {
 path:"/createownproduct/:userid",
 ...
 {
  path:"/inspectDesignerOrder/:product",
  element:<InspectDesignerOrder/>
 },
   {
    path:"/genimg",
    element:<Genimg/>,
